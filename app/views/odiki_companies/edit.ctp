<!-- file /app/views/odiki_companies/edit.ctp -->
<?php 
...
?>
<div class="post">
	<div class="post_title"><h2>Ενημέρωση Στοιχείων Εταιρίας Οδικής Βοήθειας</h2></div>
	<div class="post_body">
		<?php
			echo $form->create('OdikiCompany', array('action' => 'edit'));
